...
export const technologyData: Technology[] = [
    ...
    { id: "dynamodb", name: "DynamoDB", category: "Database", description: "NoSQL database service", website: "https://aws.amazon.com/dynamodb", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/amazonwebservices/amazonwebservices-original.svg", npm: "npm install @aws-sdk/client-dynamodb" },
    { id: "cockroachdb", name: "CockroachDB", category: "Database", description: "Distributed SQL database", website: "https://cockroachlabs.com", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/cockroachdb/cockroachdb-original.svg", npm: "npm install pg" },
    { id: "neon", name: "Neon", category: "Database", description: "Serverless Postgres", website: "https://neon.tech", icon: "https://neon.tech/favicon/favicon-32x32.png", npm: "npm install @neondatabase/serverless" },
    { id: "xata", name: "Xata", category: "Database", description: "Serverless database with built-in search", website: "https://xata.io", icon: "https://xata.io/favicon.ico", npm: "npm install @xata.io/client" },
    ...
    { id: "adonisjs", name: "AdonisJS", category: "Backend Framework", description: "Node.js web framework", website: "https://adonisjs.com", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/adonisjs/adonisjs-original.svg", npm: "npm init adonisjs@latest" },
    { id: "elysia", name: "Elysia", category: "Backend Framework", description: "Fast and ergonomic Bun web framework", website: "https://elysiajs.com", icon: "https://elysiajs.com/assets/elysia.svg", npm: "bun add elysia" },
    ...
    { id: "panda-css", name: "Panda CSS", category: "CSS Framework", description: "Zero-runtime CSS-in-JS", website: "https://panda-css.com", icon: "https://panda-css.com/favicon.ico", npm: "npm install -D @pandacss/dev" },
    { id: "unocss", name: "UnoCSS", category: "CSS Framework", description: "Instant on-demand atomic CSS engine", website: "https://unocss.dev", icon: "https://unocss.dev/favicon.svg", npm: "npm install -D unocss" },
    { id: "styled-components", name: "Styled Components", category: "CSS Framework", description: "CSS-in-JS library", website: "https://styled-components.com", icon: "https://styled-components.com/favicon.png", npm: "npm install styled-components" },
    { id: "emotion", name: "Emotion", category: "CSS Framework", description: "CSS-in-JS library", website: "https://emotion.sh", icon: "", npm: "npm install @emotion/react @emotion/styled" },
    ...
    { id: "cypress", name: "Cypress", category: "Testing", description: "Fast, easy and reliable testing for anything that runs in a browser", website: "https://cypress.io", color: "#17202C", npm: "npm install cypress", icon: "https://asset.brandfetch.io/idIq_kF0rb/idv3zwmSiY.jpeg" },
    ...
    { id: "storybook", name: "Storybook", category: "Testing", description: "UI component development environment", website: "https://storybook.js.org", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/storybook/storybook-original.svg", npm: "npx storybook@latest init" },
    { id: "msw", name: "Mock Service Worker (MSW)", category: "Testing", description: "API mocking library", website: "https://mswjs.io", icon: "https://mswjs.io/img/msw-logo.svg", npm: "npm install msw" },
    ...
    { id: "lucia", name: "Lucia", category: "Authentication", description: "Authentication library for TypeScript", website: "https://lucia-auth.com", icon: "https://lucia-auth.com/icon.png", npm: "npm install lucia" },
    { id: "better-auth", name: "Better Auth", category: "Authentication", description: "The most comprehensive authentication framework", website: "https://better-auth.com", icon: "", npm: "npm install better-auth" },
    { id: "passport", name: "Passport.js", category: "Authentication", description: "Authentication middleware for Node.js", website: "https://passportjs.org", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg", npm: "npm install passport" },
    ...
    { id: "mobx", name: "MobX", category: "State Management", description: "Simple, scalable state management", website: "https://mobx.js.org", icon: "https://mobx.js.org/img/mobx.png", npm: "npm install mobx mobx-react-lite" },
    { id: "xstate", name: "XState", category: "State Management", description: "State machines and statecharts", website: "https://xstate.js.org", icon: "https://xstate.js.org/img/logo.svg", npm: "npm install xstate" },
    { id: "nanostores", name: "Nanostores", category: "State Management", description: "Tiny state manager", website: "https://github.com/nanostores/nanostores", icon: "https://avatars.githubusercontent.com/u/84611369?s=200&v=4", npm: "npm install nanostores" },
    ...
    { id: "coolify", name: "Coolify", category: "Hosting", description: "Self-hostable Heroku/Netlify alternative", website: "https://coolify.io", icon: "https://coolify.io/favicon.ico", npm: "# Deploy via Docker" },
    { id: "dokku", name: "Dokku", category: "Hosting", description: "Docker-powered PaaS", website: "https://dokku.com", icon: "", npm: "# Deploy via Git push" },
    { id: "heroku", name: "Heroku", category: "Hosting", description: "Cloud platform as a service", website: "https://heroku.com", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/heroku/heroku-original.svg", npm: "npm install -g heroku" },

    // API/GraphQL Tools
    { id: "apollo-graphql", name: "Apollo GraphQL", category: "API/GraphQL Tools", description: "Complete GraphQL platform", website: "https://apollographql.com", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/apollographql/apollographql-original.svg", npm: "npm install @apollo/client graphql" },
    { id: "graphql-yoga", name: "GraphQL Yoga", category: "API/GraphQL Tools", description: "Fully-featured GraphQL server", website: "https://the-guild.dev/graphql/yoga-server", icon: "https://the-guild.dev/favicon.ico", npm: "npm install graphql-yoga graphql" },
    { id: "hasura", name: "Hasura", category: "API/GraphQL Tools", description: "Instant GraphQL on databases", website: "https://hasura.io", icon: "https://hasura.io/favicon.ico", npm: "# Deploy via Docker" },
    { id: "pothos", name: "Pothos", category: "API/GraphQL Tools", description: "Code-first GraphQL schema builder", website: "https://pothos-graphql.dev", icon: "https://pothos-graphql.dev/img/logo.svg", npm: "npm install @pothos/core graphql" },
    { id: "graphql-codegen", name: "GraphQL Code Generator", category: "API/GraphQL Tools", description: "Generate code from GraphQL schemas", website: "https://the-guild.dev/graphql/codegen", icon: "https://the-guild.dev/favicon.ico", npm: "npm install -D @graphql-codegen/cli" },

    // Real-time/WebSocket
    { id: "socketio", name: "Socket.io", category: "Real-time/WebSocket", description: "Real-time bidirectional communication", website: "https://socket.io", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/socketio/socketio-original.svg", npm: "npm install socket.io socket.io-client" },
    { id: "pusher", name: "Pusher", category: "Real-time/WebSocket", description: "Hosted real-time messaging service", website: "https://pusher.com", icon: "https://avatars.githubusercontent.com/u/739550?s=200&v=4", npm: "npm install pusher pusher-js" },
    { id: "ably", name: "Ably", category: "Real-time/WebSocket", description: "Real-time messaging platform", website: "https://ably.com", icon: "https://ably.com/favicon.ico", npm: "npm install ably" },
    { id: "partykit", name: "Partykit", category: "Real-time/WebSocket", description: "Real-time infrastructure for multiplayer apps", website: "https://partykit.io", icon: "", npm: "npm install partykit" },

    // CMS (Content Management)
    { id: "sanity", name: "Sanity", category: "CMS (Content Management)", description: "Platform for structured content", website: "https://sanity.io", icon: "https://sanity.io/favicon.ico", npm: "npm install @sanity/client" },
    { id: "contentful", name: "Contentful", category: "CMS (Content Management)", description: "Headless CMS and content platform", website: "https://contentful.com", icon: "https://www.contentful.com/favicon.ico", npm: "npm install contentful" },
    { id: "strapi", name: "Strapi", category: "CMS (Content Management)", description: "Open-source headless CMS", website: "https://strapi.io", icon: "https://strapi.io/favicon.ico", npm: "npx create-strapi-app@latest" },
    { id: "payload", name: "Payload CMS", category: "CMS (Content Management)", description: "TypeScript headless CMS", website: "https://payloadcms.com", icon: "https://payloadcms.com/favicon.ico", npm: "npx create-payload-app@latest" },
    { id: "keystatic", name: "Keystatic", category: "CMS (Content Management)", description: "Content management for the component age", website: "https://keystatic.com", icon: "https://keystatic.com/favicon.ico", npm: "npm install @keystatic/core" },

    // Search
    { id: "algolia", name: "Algolia", category: "Search", description: "AI-powered search and discovery", website: "https://algolia.com", icon: "https://www.algolia.com/favicon.ico", npm: "npm install algoliasearch" },
    { id: "meilisearch", name: "Meilisearch", category: "Search", description: "Lightning-fast search engine", website: "https://meilisearch.com", icon: "https://www.meilisearch.com/favicon.ico", npm: "npm install meilisearch" },
    { id: "typesense", name: "Typesense", category: "Search", description: "Fast, typo-tolerant search engine", website: "https://typesense.org", icon: "https://typesense.org/favicon.ico", npm: "npm install typesense" },
    { id: "elasticsearch", name: "ElasticSearch", category: "Search", description: "Distributed search and analytics engine", website: "https://elastic.co", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/elasticsearch/elasticsearch-original.svg", npm: "npm install @elastic/elasticsearch" },

    // Validation
    { id: "zod", name: "Zod", category: "Validation", description: "TypeScript-first schema validation", website: "https://zod.dev", icon: "https://zod.dev/favicon.ico", npm: "npm install zod" },
    { id: "yup", name: "Yup", category: "Validation", description: "Schema validation library", website: "https://github.com/jquense/yup", icon: "https://raw.githubusercontent.com/jquense/yup/master/docs/public/favicon.ico", npm: "npm install yup" },
    { id: "joi", name: "Joi", category: "Validation", description: "Data validator for JavaScript", website: "https://joi.dev", icon: "https://joi.dev/img/favicon.ico", npm: "npm install joi" },
    { id: "valibot", name: "Valibot", category: "Validation", description: "Schema library with bundle size focus", website: "https://valibot.dev", icon: "https://valibot.dev/favicon.ico", npm: "npm install valibot" },

    // Email
    { id: "resend", name: "Resend", category: "Email", description: "Modern email API for developers", website: "https://resend.com", icon: "https://resend.com/favicon.ico", npm: "npm install resend" },
    { id: "sendgrid", name: "SendGrid", category: "Email", description: "Email delivery service", website: "https://sendgrid.com", icon: "https://sendgrid.com/favicon.ico", npm: "npm install @sendgrid/mail" },
    { id: "postmark", name: "Postmark", category: "Email", description: "Fast and reliable transactional email", website: "https://postmarkapp.com", icon: "https://postmarkapp.com/favicon.ico", npm: "npm install postmark" },
    { id: "react-email", name: "React Email", category: "Email", description: "Build and send emails using React", website: "https://react.email", icon: "https://react.email/favicon.ico", npm: "npm install @react-email/components" },

    // Analytics
    { id: "posthog", name: "PostHog", category: "Analytics", description: "Product analytics platform", website: "https://posthog.com", icon: "https://posthog.com/favicon.ico", npm: "npm install posthog-js" },
    { id: "plausible", name: "Plausible", category: "Analytics", description: "Privacy-friendly analytics", website: "https://plausible.io", icon: "https://plausible.io/favicon.ico", npm: "npm install plausible-tracker" },
    { id: "umami", name: "Umami", category: "Analytics", description: "Simple, fast, privacy-focused analytics", website: "https://umami.is", icon: "https://umami.is/favicon.ico", npm: "# Deploy via Docker" },
    { id: "google-analytics", name: "Google Analytics", category: "Analytics", description: "Web analytics service", website: "https://analytics.google.com", icon: "https://www.google.com/favicon.ico", npm: "npm install @vercel/analytics" },

    // Payment
    { id: "stripe", name: "Stripe", category: "Payment", description: "Payment processing platform", website: "https://stripe.com", icon: "https://stripe.com/favicon.ico", npm: "npm install stripe @stripe/stripe-js" },
    { id: "paypal", name: "PayPal", category: "Payment", description: "Online payment system", website: "https://paypal.com", icon: "https://www.paypal.com/favicon.ico", npm: "npm install @paypal/checkout-server-sdk" },
    { id: "lemon-squeezy", name: "Lemon Squeezy", category: "Payment", description: "Merchant of record platform", website: "https://lemonsqueezy.com", icon: "https://lemonsqueezy.com/favicon.ico", npm: "npm install @lemonsqueezy/lemonsqueezy.js" },

    // Storage/CDN
    { id: "cloudinary", name: "Cloudinary", category: "Storage/CDN", description: "Media management and optimization", website: "https://cloudinary.com", icon: "https://cloudinary.com/favicon.ico", npm: "npm install cloudinary" },
    { id: "uploadthing", name: "UploadThing", category: "Storage/CDN", description: "File uploads for web apps", website: "https://uploadthing.com", icon: "https://uploadthing.com/favicon.ico", npm: "npm install uploadthing" },
    { id: "aws-s3", name: "AWS S3", category: "Storage/CDN", description: "Object storage service", website: "https://aws.amazon.com/s3", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/amazonwebservices/amazonwebservices-original.svg", npm: "npm install @aws-sdk/client-s3" },
    { id: "vercel-blob", name: "Vercel Blob", category: "Storage/CDN", description: "Edge-compatible file storage", website: "https://vercel.com/storage/blob", icon: "https://assets.vercel.com/image/upload/v1662130559/nextjs/Icon_light_background.png", npm: "npm install @vercel/blob" }
];
